...
Channel.value(params.mate).into{g_1_mate_g_2;g_1_mate_g3_0;g_1_mate_g3_5;g_1_mate_g3_7;g_1_mate_g6_9;g_1_mate_g6_12;g_1_mate_g6_11;g_1_mate_g8_9;g_1_mate_g11_15;g_1_mate_g11_19;g_1_mate_g11_12;g_1_mate_g15_9;g_1_mate_g15_12;g_1_mate_g15_11}
...
output:
 set val(name),file("*.fastq")  into g_2_reads0_g3_0
...
input:
 set val(name),file(reads) from g_2_reads0_g3_0
 val mate from g_1_mate_g3_0

output:
 set val(name), file("*_${method}-pass.fast*")  into g3_0_reads0_g6_11
...
input:
 val mate from g_1_mate_g6_11
 set val(name),file(reads) from g3_0_reads0_g6_11

output:
 set val(name), file("*_primers-pass.fast*") optional true  into g6_11_reads0_g8_9
 set val(name), file("*_primers-fail.fast*") optional true  into g6_11_reads_failed11
...
process Pair_Sequence_pair_seq {

input:
 set val(name),file(reads) from g6_11_reads0_g8_9
 val mate from g_1_mate_g8_9

output:
 set val(name),file("*_pair-pass.fastq")  into g8_9_reads0_g11_12
 set val(name),file("out*")  into g8_9_logFile11

script:
coord = params.Pair_Sequence_pair_seq.coord
act = params.Pair_Sequence_pair_seq.act
copy_fields_1 = params.Pair_Sequence_pair_seq.copy_fields_1
copy_fields_2 = params.Pair_Sequence_pair_seq.copy_fields_2
failed = params.Pair_Sequence_pair_seq.failed
nproc = params.Pair_Sequence_pair_seq.nproc
head_seqeunce_file = params.Pair_Sequence_pair_seq.head_seqeunce_file
...
publishDir params.outdir, mode: 'copy', saveAs: {filename -> if (filename =~ /.*table.tab$/) "MP_log/$filename"}
input:
 val mate from g_1_mate_g6_9
 set val(name), file(log_file) from g6_11_logFile2_g6_9

output:
 file "*table.tab"  into g6_9_logFile0_g6_12, g6_9_logFile0_g6_19
...
input:
 file primers from g6_9_logFile0_g6_12
 val mate from g_1_mate_g6_12

output:
 file "*.rmd"  into g6_12_rMarkdown0_g6_19
...
input:
 file rmk from g6_12_rMarkdown0_g6_19
 file log_file from g6_9_logFile0_g6_19

output:
 file "*.html" optional true  into g6_19_outputFileHTML00
 file "*csv" optional true  into g6_19_csvFile11
...
input:
 set val(name),file(reads) from g8_9_reads0_g11_12
 val mate from g_1_mate_g11_12

output:
 set val(name),file("*_assemble-pass.f*")  into g11_12_reads0_g15_11
...
input:
 val mate from g_1_mate_g15_11
 set val(name),file(reads) from g11_12_reads0_g15_11
